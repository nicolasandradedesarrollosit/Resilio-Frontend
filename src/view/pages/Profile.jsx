    ...
    return (
            <main className='background-profile'>
                ...
                <div className='profile-first-row'>
                    <h2 className='title-section'>{userData.name}</h2>
                    <span className={userData.email_verified ? 'verified' : 'not-verified'}>{userData.email_verified ? 'Verificado' : 'No verificado'}</span>
                </div>
                <div className='profile-second-row'>
                    ...
                    <div className='stats-text'>
                        <span className='title-stats'>{userData.points_user}</span>
                    ...
                    <div className='stats-text'>
                        <span className='title-stats'>{userData.q_of_redeemed}</span>
                ...
                <div className='personal-info-row'>
                    ...
                    <div>
                        <p className='title-info'>{userData.city}, {userData.province}</p>
                        <span className='subtitle-info'>Ubicación</span>
                    </div>
                    </span>
                    <span className='info-item'>
                    ...
                    <div>
                        <p className='title-info'>{userData.phone_number}</p>
                        <span className='subtitle-info'>Teléfono</span>
                    </div>
                    </span>
                    <span className='info-item'>
                    ...
                    <div>
                        <p className='title-info'>{userData.email}</p>
                    ...
                    <div>
                        <p className='title-info'>{userData.ispremium ? 'Premium' : 'No Premium'}</p>
